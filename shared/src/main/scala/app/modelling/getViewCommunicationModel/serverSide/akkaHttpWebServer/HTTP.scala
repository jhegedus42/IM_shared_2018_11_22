package app.modelling.getViewCommunicationModel.serverSide.akkaHttpWebServer

import app.modelling.getViewCommunicationModel.serverSide.logic.ServerSideLogic.ServerLogicTypeClass
import app.modelling.getViewCommunicationModel.shared.CirceUtils._
import app.modelling.getViewCommunicationModel.shared.{GetViewHttpRouteName, GetViewHttpRouteProvider}
import app.modelling.getViewCommunicationModel.shared.views.View1_HolderObject.{View1, View1_Par}
import app.modelling.getViewCommunicationModel.shared.views.View2_HolderObject.View2
import app.modelling.getViewCommunicationModel.shared.views.{View, View1_HolderObject}
