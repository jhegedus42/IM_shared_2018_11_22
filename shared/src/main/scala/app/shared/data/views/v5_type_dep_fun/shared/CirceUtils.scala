...
object CirceUtils {
  ...
  def decodeJSONContainingOptResToOptRes[V <: View](res: JSONContainingOptRes)(implicit e: Decoder[V#Res] ): Either[Error, V#Res] = {
    val r: Either[Error, V#Res] = decode( res.string)
    r
  }

  def decodeJSONToPar[V <: View](res: JSONContainingGetViewPar)(implicit e: Decoder[V#Par] ): Either[Error, V#Par] = {
    val r: Either[Error, V#Par] = decode( res.string)
    r
  }

  def encodeOptResToJSONContainingOptRes[V <: View](r: Option[V#Res] )(implicit e: Encoder[Option[V#Res]] ): JSONContainingOptRes = {
