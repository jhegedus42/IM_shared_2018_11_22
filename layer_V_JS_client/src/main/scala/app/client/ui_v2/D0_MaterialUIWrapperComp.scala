...
/**
  *
  * [[D0_MaterialUIWrapperComp.rootCompConstructor]] is used by [[japgolly.scalajs.react.ReactDOM.render()]]
  * in [[app.client.Main]] to create the root react component.
  *
  * The React Comp Hierarchy is the following :
  * [[D0_MaterialUIWrapperComp]] -> [[MuiMuiThemeProvider]] -> [[Router]] ->
  *
  * 55ec29a9_83dd163e
  */

object D0_MaterialUIWrapperComp {
