...
//  val que = new CacheRoot()
  ...
  val constructor_used_by_the_parent_component
    : Constructor_Used_By_The_Parent_Component[LineDetail_Vanilla_RootReactComp_PhantomType.type,
                                               LineDetail_ReactComp.Prop] =
    comp_constructor_enhancer.create_Enhanced_RootReactComp_Constructor[
