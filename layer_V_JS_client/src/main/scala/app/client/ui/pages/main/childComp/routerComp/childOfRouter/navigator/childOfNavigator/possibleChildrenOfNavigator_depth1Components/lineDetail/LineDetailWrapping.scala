...
//  val que = new CacheRoot()
  ...
  val constructor_used_by_the_parent_component
    : Depth1CompConstr_Alias[LineDetail_URL, LineDetail_CompConstr_Holder.Depth1CompProps_Alias] =
    enhancer.create_Depth1CompConstr_by_wrapping_Depth2CompConstructor[
      LineDetail_URL,
      LineDetail_CompConstr_Holder.Depth1CompProps_Alias
    ](
