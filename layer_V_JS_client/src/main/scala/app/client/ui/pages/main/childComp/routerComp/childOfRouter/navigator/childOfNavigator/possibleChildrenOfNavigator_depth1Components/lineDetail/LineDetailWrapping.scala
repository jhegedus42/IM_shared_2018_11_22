...
import app.client.ui.pages.main.childComp.routerComp.childOfRouter.navigator.childOfNavigator.possibleChildrenOfNavigator_depth1Components.lineDetail.LineDetail_ReactComp.lineDetailConstructor
...
//  val que = new CacheRoot()
  ...
  val constructor_used_by_the_parent_component: Depth1CompConstr[LineDetail_Page, LineDetail_ReactComp.Prop] =
