...
import app.client.ui.pages.main.childComp.routerComp.childOfRouter.navigator.childOfNavigator.possibleChildrenOfNavigator.lineList.ListReorderService
...
object SortableContainer {
  ...
  case class Props(
    ...
    private[generalReactComponents] def toJS = {
      ...
      def permutationFromJS(p: PermutationJS): ListReorderService = ListReorderService(p.oldIndex, p.newIndex)
