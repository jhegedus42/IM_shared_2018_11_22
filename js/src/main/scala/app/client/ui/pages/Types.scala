...
object Types {
  type Vanilla_CompConstr[CompName<:TopPageCompType, P] =
    ReqProps[PropsHolder[P,CompName], Unit, _, TopNode]
  type Wrapped_CompConstr[CompName<:TopPageCompType, P] =
    ReqProps[(P, RouterCtl[Page]), CacheMap, _, TopNode]
