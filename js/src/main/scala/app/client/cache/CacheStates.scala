...
sealed abstract class CacheVal[E <: Entity]
{
...
abstract class Pending[E <: Entity] extends CacheVal[E]

abstract class Failed[E <: Entity] extends CacheVal[E]

abstract class Ready[E <: Entity]() extends CacheVal[E]{
  def refVal:RefVal[E]
}



case class NotInCache[E <: Entity](val ref:Ref[E]) extends CacheVal[E]

case class NotYetLoaded[E <: Entity](val ref:Ref[E]) extends CacheVal[E]
