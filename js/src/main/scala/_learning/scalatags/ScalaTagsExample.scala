package _learning.scalatags

import scala.scalajs.js.annotation.JSExport
import org.scalajs.dom
class ScalaTagsExample[Builder, Output <: FragT, FragT]
(val bundle: scalatags.generic.Bundle[Builder, Output, FragT]){
  ...
  val svgFrag = {
    val i="https://static.pexels.com/photos/60224/pexels-photo-60224.jpeg"
    import bundle.implicits._
    import bundle.svgTags._
    import bundle.svgAttrs._
    svg(height := "800", width := "500")(
      image(xLinkHref:= i,height:="250px",width:="250px"),

      g(transform:="translate(250,130) rotate(10 50 50) scale(1)")(
        bundle.svgTags.clipPath(id:="cut")(rect (
          x:="100px", y:="120px",height:="100px", width:="100px")()
        ),
        image(xLinkHref:= i,height:="250px",width:="250px", bundle.svgAttrs.clipPath:="url(#cut)")
      ),
