package app.model_to_be_moved_to_real_app.getViewCommunicationModel.client

import app.model_to_be_moved_to_real_app.getViewCommunicationModel.client.ViewCacheStates.ViewCacheState
import app.model_to_be_moved_to_real_app.getViewCommunicationModel.shared.views.{View1_HolderObject, View2_HolderObject}
import app.model_to_be_moved_to_real_app.getViewCommunicationModel.shared.views.View1_HolderObject.{View1, View1_Par}
import app.model_to_be_moved_to_real_app.getViewCommunicationModel.shared.views.View2_HolderObject.{View2, View2_Par}
import io.circe._
