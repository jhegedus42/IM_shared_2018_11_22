...
import app.modelling.getViewCommunicationModel.client.ViewCacheStates.ViewCacheState
import app.modelling.getViewCommunicationModel.shared.views.{View1_HolderObject, View2_HolderObject}
import app.modelling.getViewCommunicationModel.shared.views.View1_HolderObject.{View1, View1_Par}
import app.modelling.getViewCommunicationModel.shared.views.View2_HolderObject.{View2, View2_Par}
import io.circe._
